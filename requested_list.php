		...
		<div id="main-container"
			...
			<?php
				 require_once('db_connection.php');
                    $res = mysqli_query($con, "Select * from blood_req");
                    $num= mysqli_num_rows($res);
				// print "<table border=1>";
			?>
			<h3>Blood Request List</h3>	
   <form action="/bloodbank/requested_list.php">			
			 <table width="100%" border="0" cellspacing="5" cellpadding="5">
			  <tr style="background-color: #d2322d">
				...
				<td><strong>Is_Blood_Deliverd</strong></td
			  </tr>
			...
			<?php
				while ($row = mysqli_fetch_row($res))
				{
						...
						echo "<td> <input type='checkbox' name='chkbox[]' value='yes'>Yes</td>" ;
...
$sql = mysqli_query($con, "INSERT INTO delivery_status (status) VALUES ('$chkNew')");
